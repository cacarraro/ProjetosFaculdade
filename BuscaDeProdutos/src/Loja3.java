...
public class Loja3
{
    private static Produto tv = new Produto("televisao samsung oled", 500);
    private static Produto notebook = new Produto("notebook asus", 500);
    private static Produto celular = new Produto("celular iphone apple", 400);
    private static Produto cama = new Produto("cama box solteiro", 70);

    private static Produto[] catalogo = {tv, notebook, celular, cama};
