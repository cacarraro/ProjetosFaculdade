...
public class Calculador_4 {
    public static void main(String[] args) {
        try {
            ServerSocket server = new ServerSocket(9093);
            ...
            while (k < 1)
            {
                ...
                System.out.println("recebeu matriz a 4");
                Matriz mtrxB = (Matriz) leitor.readObject();
                System.out.println("recebeu matriz b 4");
                Integer inicio = (Integer) leitor.readObject();
                System.out.println("recebeu inicio 4: " + inicio);
                Integer fim = (Integer) leitor.readObject();
                System.out.println("recebeu fim 4: " + fim);
