    ...
    public static void main(String[] args) {
        try {
            ...
            while (k < 1)
            {
                ...
                System.out.println("recebeu matriz a 3");
                Matriz mtrxB = (Matriz) leitor.readObject();
                System.out.println("recebeu matriz b 3");
                Integer inicio = (Integer) leitor.readObject();
                System.out.println("recebeu inicio 3: " + inicio);
                Integer fim = (Integer) leitor.readObject();
                System.out.println("recebeu fim 3: " + fim);
