    ...
    public static void main(String[] args) {
        try {
            ...
            while (k < 1)
            {
                ...
                System.out.println("recebeu matriz a 2");
                Matriz mtrxB = (Matriz) leitor.readObject();
                System.out.println("recebeu matriz b 2");
                Integer inicio = (Integer) leitor.readObject();
                System.out.println("recebeu inicio 2: " + inicio);
                Integer fim = (Integer) leitor.readObject();
                System.out.println("recebeu fim 2: " + fim);
